<?php
    ...
    $sql = "SELECT domicilios.*, clientes.nombre, clientes.direccion, clientes.celular FROM domicilios inner join clientes on clientes.id = domicilios.id_cliente where celular = '$celular' order by domicilios.id DESC";
